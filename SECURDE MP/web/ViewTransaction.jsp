      ...
      <div>
        <div class="section">
          <div class="container" style="margin-top:7em">
            <div class="jumbotron" style="opacity:0.9; border-radius:5px">
              <h1 style="color:184a4a">View Transaction</h1>
              ...
              <div class="form-group">
                <div class="col-sm-2">
                  <label for="inputEmail3" class="control-label">Date of Transaction</label>
                </div>
                <div class="col-sm-10">
                  <label class="control-label">June 24, 2017</label>
                </div>
              </div>
              <a href="#"></a>
              <table class="table">
